...
export const TOOL_REGISTRY: ToolConfig[] = [
  {
    ...
    category: "Numbers",
    icon: Hash,
    metaTitle: "Random Number Generator: Pick a Number Instantly | BestRandom",
    metaDescription: "Generate truly random numbers with full control over range, count, uniqueness, and decimals. Repeat or share the same results anytime with seeds.",
  ...
  },
  {
    ...
    category: "Text",
    icon: User,
    metaTitle: "Random Name Generator: Create Realistic Names Instantly | BestRandom",
    metaDescription: "Generate random first and last names for characters, testing, or creative projects. Choose modern or classic styles, ensure uniqueness, and share results.",
  ...
  },
  {
    ...
    category: "Text",
    icon: User,
    metaTitle: "Last Name Generator: Find Random Surnames & Family Names | BestRandom",
    metaDescription: "Generate random last names from a dataset of real English surnames. Great for fiction writing, game characters, form testing, or genealogy research.",
  ...
  },
  {
    ...
    category: "Text",
    icon: FileText,
    metaTitle: "Random Word Generator: Get Random English Words in Seconds | BestRandom",
    metaDescription: "Generate random English words with adjustable length. Perfect for word games, brainstorming, vocabulary practice, or creative writing prompts.",
  ...
  },
  {
    ...
    category: "Selection",
    icon: Shuffle,
    metaTitle: "Random Picker: Who Should Go First? Pick Instantly | BestRandom",
    metaDescription: "Randomly pick a winner from any list. Spin a wheel or pick instantly with weighted probabilities. Fair, shareable, and repeatable with seeds.",
    h1: "Random Picker",
  ...
  },
  {
    ...
    category: "Design",
    icon: Palette,
    metaTitle: "Random Color Generator: Get HEX, RGB & HSL Colors Instantly | BestRandom",
    metaDescription: "Generate random color palettes for design projects. Export HEX, RGB, or HSL values, lock favorite colors, and share palettes with a link.",
  ...
  },
  {
    ...
    category: "Security",
    icon: Key,
    metaTitle: "Random Password Generator: Create Strong Passwords Instantly | BestRandom",
    metaDescription: "Generate secure random passwords with custom length, uppercase, lowercase, numbers, and symbols. All passwords are generated locally and never stored.",
  ...
  },
  {
    ...
    category: "Fun",
    icon: PawPrint,
    metaTitle: "Random Animal Generator: What Animal Are You? Discover Now | BestRandom",
    metaDescription: "Generate random animals from mammals, birds, reptiles, and more. Great for trivia games, educational activities, or just for fun.",
  ...
  },
  {
    ...
    category: "Text",
    icon: Type,
    metaTitle: "Random Text Generator: Create Placeholder Text Instantly | BestRandom",
    metaDescription: "Generate random placeholder text for UI mockups, design testing, or layout prototyping. Choose short, medium, or long output with repeatable seeds.",
  ...
  },
  {
    ...
    category: "Selection",
    icon: Users,
    metaTitle: "Random Team Generator: Divide Groups Fairly in Seconds | BestRandom",
    metaDescription: "Split any group into balanced random teams instantly. Perfect for sports, classrooms, hackathons, or project assignments. Shareable and repeatable.",
  ...
  },
  {
    ...
    category: "Text",
    icon: Mail,
    metaTitle: "Random Email Generator: Create Test Email Addresses Fast | BestRandom",
    metaDescription: "Generate realistic random email addresses for software testing, form validation, or placeholder data. Choose name-based, username, or random formats.",
  ...
  },
  {
    ...
    category: "Text",
    icon: Globe,
    metaTitle: "Random Website Generator: Create Fake URLs for Testing | BestRandom",
    metaDescription: "Generate random website URLs with custom TLDs, subdomains, and paths. Ideal for development testing, UI mockups, and placeholder data.",
