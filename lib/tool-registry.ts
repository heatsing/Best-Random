...
export const TOOL_REGISTRY: ToolConfig[] = [
  {
    ...
    category: "Numbers",
    icon: Hash,
    metaTitle: "Random Number Generator – Fast, Seeded & Shareable | BestRandom",
    metaDescription: "Generate truly random numbers instantly. Control range, count, uniqueness, decimals, and seed. Repeat or share the same results anytime.",
  ...
  },
  {
    ...
    category: "Text",
    icon: User,
    metaTitle: "Random Name Generator – Instant & Repeatable | BestRandom",
    metaDescription: "Generate random names instantly. Choose full names, first names, or last names. Use a seed to repeat or share results.",
  ...
  },
  {
    ...
    category: "Text",
    icon: User,
    metaTitle: "Family Name Generator – Random Last Names | BestRandom",
    metaDescription: "Generate random last names and family names instantly. Choose count and uniqueness. Use a seed to repeat or share results.",
  ...
  },
  {
    ...
    category: "Text",
    icon: FileText,
    metaTitle: "Random Word Generator – Quick & Seeded | BestRandom",
    metaDescription: "Generate random words instantly. Control word length, count, and repeat results using a seed. Simple and fast.",
  ...
  },
  {
    ...
    category: "Selection",
    icon: Shuffle,
    metaTitle: "Random Picker & Wheel – Fair Random Selection | BestRandom",
    metaDescription: "Randomly pick items from your list. Spin a wheel or pick instantly. Supports seeds, weights, and shareable results.",
    h1: "Random Picker",
  ...
  },
  {
    ...
    category: "Design",
    icon: Palette,
    metaTitle: "Random Color Generator – HEX, RGB & HSL | BestRandom",
    metaDescription: "Generate random colors instantly. Create color palettes, lock colors, and export HEX, RGB, or HSL values.",
  ...
  },
  {
    ...
    category: "Security",
    icon: Key,
    metaTitle: "Random Password Generator – Secure & Customizable | BestRandom",
    metaDescription: "Create strong random passwords instantly. Control length, characters, and generate multiple secure passwords at once.",
  ...
  },
  {
    ...
    category: "Fun",
    icon: PawPrint,
    metaTitle: "Random Animal Generator – Instant & Fun | BestRandom",
    metaDescription: "Generate random animals instantly. Filter by category and repeat results using a seed.",
  ...
  },
  {
    ...
    category: "Text",
    icon: Type,
    metaTitle: "Random Text Generator – Quick Placeholder Text | BestRandom",
    metaDescription: "Generate random text instantly. Create short or long placeholder text with repeatable results using a seed.",
  ...
  },
  {
    ...
    category: "Selection",
    icon: Users,
    metaTitle: "Random Team Generator – Fair Team Distribution | BestRandom",
    metaDescription: "Randomly divide people into teams. Support balanced distribution, custom team names, and repeatable results using a seed.",
  ...
  },
  {
    ...
    category: "Text",
    icon: Mail,
    metaTitle: "Random Email Generator – Quick & Repeatable | BestRandom",
    metaDescription: "Generate random email addresses instantly. Choose format, domain, and count. Use a seed to repeat or share results.",
  ...
  },
  {
    ...
    category: "Text",
    icon: Globe,
    metaTitle: "Random Website Generator – Quick URLs | BestRandom",
    metaDescription: "Generate random website URLs instantly. Choose format, TLD, and count. Use a seed to repeat or share results.",
