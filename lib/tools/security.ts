...
export const randomPasswordTool: ToolConfig = {
  ...
  seo: {
    title: "Random Password Generator - Strong & Secure | Free Online",
    description: "Generate strong random passwords with custom length, uppercase, lowercase, numbers & symbols. Generated locally, never stored. 100% secure & free!",
...
export const uuidGeneratorTool: ToolConfig = {
  ...
  seo: {
    title: "UUID Generator - Create v4 Unique IDs | Standard & Compact",
    description: "Generate UUID v4 identifiers instantly. Standard or compact format. Perfect for databases, APIs, and unique keys in your applications. Free online!",
    h1: "UUID Generator",
    faq: [
...
export const hashGeneratorTool: ToolConfig = {
  ...
  seo: {
    title: "Hash Generator - SHA-256, SHA-512 & MD5 | Text to Hash Online",
    description: "Convert text to cryptographic hashes. Supports SHA-256, SHA-512, and MD5 for data integrity and security verification. Free online hash tool!",
    h1: "Hash Generator",
    faq: [
